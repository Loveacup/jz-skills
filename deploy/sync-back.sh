...
PAIRS=(
  ...
  "hermes/agent-security-audit|governance/agent-security-audit"
  ...
  "hermes/agent-cost-manager|devops/agent-cost-manager"
  "hermes/agent-registry|governance/agent-registry"
  "hermes/deep-research-agent|research/deep-research-agent"
  "hermes/specialist-engineer|devops/specialist-engineer"
