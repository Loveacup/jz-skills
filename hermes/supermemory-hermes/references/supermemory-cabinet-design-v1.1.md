# Supermemory 三省六部记忆架构设计

完整设计文档位于 Obsidian vault：
`20-Areas/10_AI实践/三省六部_Hermes/10_制度/Supermemory三省六部记忆架构设计_v1.1.md`
...
1. **双池隔离**: `container_tag: "hermes"` (小黄私域) vs `"hermes-cabinet"` (太子+三省六部共享)
...
5. **渐进实施**: Phase 1 太子试点 → Phase 2 三省六部全量 → Phase 3 优化监控 → Phase 4 混合广播写
