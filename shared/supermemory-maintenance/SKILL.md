...
description: "Configure, debug, and maintain the pi-supermemory extension and Supermemory API integration. Use when supermemory tool errors, 403, crashes, config changes, or extension code needs modification."
version: 2
created: "2026-05-28"
updated: "2026-05-29"
---
...
Do NOT use for: (1) Routine add/search/list/forget operations — those are the tool itself, not maintenance. (2) General memory strategy discussions. (3) Other tools that happen to store data.
