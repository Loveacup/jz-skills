...
> [!tip] 深度门槛 G3：全量版 ≥3 条洞察，每条正文 ≥200 字（精简版 ≥2 × ≥150 字）。`### 🔥 反直觉/争议点` 不计入洞察条数。
...
> [!tip] 深度门槛 G5：全量版 ≥5 条金句（视频金句 + 弹幕金句合计；精简版 2–3 条）。每条用独立 blockquote。
...
> [!tip] 深度门槛 G7（全量版+精简版均适用）：≥3 个独特价值点 + ≥2 个局限/偏见 + ≥3 个可行动项（立即/短期/长期合计）。
